...
function AppContent() {
  ...
  const {
    ...
    isIndexing,
    indexMessage,
    fetchFiles: fetchMarkdownFiles,
    fetchStats: fetchRAGStats,
    indexDirectories,
    removeFile: removeMarkdownFile,
    getFileContent,
  } = useMarkdownFiles();
  ...
  useEffect(() => {
    ...
    fetchMarkdownFiles();
    fetchRAGStats();
  }, [fetchSessions, fetchMarkdownFiles, fetchRAGStats]);
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden">
      ...
      <Sidebar
        ...
        onIndexDirectories={indexDirectories}
